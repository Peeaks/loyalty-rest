...
///AccessToken contains information about the token, which is generated when a user is being created on login or user creation.
...
extension AccessToken {
    ...
    static func generate(for user: User) throws -> AccessToken {
        ...
        let random = try Crypto.Random.bytes(count: 128)
